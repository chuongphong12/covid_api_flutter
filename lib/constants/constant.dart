...
const countriesDailyUrl = "/daily";
const countriesConfirmedUrl = "/confirmed";
const countriesDeathsUrl = "/deaths";
const countriesRecoveredUrl = "/recovered";
const countriesTimelineUrl = "/timeline";